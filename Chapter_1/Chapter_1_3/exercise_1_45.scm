...
; by naively finding a fiex point of y |--> x/y does not converge, and that this
...
; a fixed-point search fo y |--> x/y^3 converg. On the other hand, if we average
...
; get a procedure to calculate the power of anything
(define (power b p)
  (define (iter res a n)
    (if (= n 0)
        res
